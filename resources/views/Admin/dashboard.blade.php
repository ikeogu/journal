        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="info-box">
                    ...
                    <span class="info-box-number">{{App\Article::all()->count()}}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="info-box bg-green">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{App\Publish::all()->count()}}</span>
